...
public class DeleteUser extends javax.swing.JFrame {
    ...
    private void userTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userTableMouseClicked
        try {
            int dialogResult = JOptionPane.showConfirmDialog(null, "* User details\n* Images\n* QR codes\n* Attendance\n\nAssociated with user will be deleted. \nAre you sure you want to proceed?", "Confirmationn", JOptionPane.YES_NO_OPTION);
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                fetchUser(null);
                JOptionPane.showMessageDialog(null,"User Deleted Succesfully.","Confirmation",JOptionPane.INFORMATION_MESSAGE);
            } else {
