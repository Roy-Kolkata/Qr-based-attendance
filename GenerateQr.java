...
public class GenerateQr extends javax.swing.JFrame {
    ...
    public GenerateQr() {
        initComponents();
        BDUtility.setImage(this,"images/abc1.jpg",1144, 518);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(btnSaveQr, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSaveQrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveQrActionPerformed
        try{
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null,"QR Code saved succesfully!");
            }catch(Exception ex){
                JOptionPane.showMessageDialog(this,"Error savi ng QR Code.","Error",JOptionPane.ERROR_MESSAGE);
            }
        }catch(Exception ex){
            JOptionPane.showMessageDialog(null,"Something went wrong.");
        }
    ...
    private void btnSaveQrAtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveQrAtActionPerformed
        try{
            if(out==null){
                JOptionPane.showMessageDialog(this, "No QR Genereated.!");
                return;
            }
