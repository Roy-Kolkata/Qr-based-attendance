...
public class ViewAttendance extends javax.swing.JFrame {
    ...
    public ViewAttendance() {
        initComponents();
        BDUtility.setImage(this, "images/abc1.jpg", 1101, 507);
    ...
    private void initComponents() {
        ...
        checkBoxCountry.setText("Countrty");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(dateChooserFrom, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        }
 ...
 private void loadDataInTable() {
        ...
        if(searchText!=null){
            ...
            if(fromDate!=null && toDate !=null){
                sqlQuery+="AND ua.date BEYWEEN'"+fromDate +"' AND '"+toDate+ "'";
            }else if(fromDate!=null){
                sqlQuery +=" and ua.date= '"+fromDate+ "'";
            }
        }else{
            if(fromDate!=null && toDate !=null){
                sqlQuery+="where ua.date BEYWEEN'"+fromDate +"' AND '"+toDate+ "'";
            }else if(fromDate!=null){
